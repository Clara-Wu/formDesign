    ...
    TagCloud.prototype = {
        ...
        update: function () {
            ...
            for (var j = 0, len = self.items.length; j < len; j++) {
                ...
                self.items[j].element.style.left = self.items[j].x + (self.box.offsetWidth - self.items[
                    j].offsetWidth) / 2 + "px";
                self.items[j].element.style.top = self.items[j].y + (self.box.offsetHeight - self.items[
                    j].offsetHeight) / 2 + "px";
        ...
        _getItems: function () {
            ...
            for (var i = 0; i < length; i++) {
                ...
                item.element.style.top = item.y + (self.box.offsetHeight - item.offsetHeight) / 2 +
                    "px";
                items.push(item);
            }
            return items;
